...
def populated_datastore(sample_records):
    ds = DataStore()
    records = (
        sample_records("iphone 15 pro", 
                       "apple", 
                       999, 
                       4.9),
        sample_records("galaxy s23 ultra", 
                       "samsung", 
                       1199, 
                       4.8),
        sample_records("redmi note 12", 
                       "xiaomi", 
                       199, 
                       4.6),
        sample_records("iphone 14", 
                       "apple", 
                       799, 
                       4.7),
        sample_records("galaxy a54", 
                       "samsung", 
                       349, 
                       4.2),
